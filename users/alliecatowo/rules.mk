VALID_POINTING_DEVICE_CONFIGURATIONS := trackball tps43 trackball_tps43
...
ifdef POINTING_DEVICE
    SRC += $(USER_PATH)/holykeebs.c $(USER_PATH)/hk_debug.c $(USER_PATH)/rpc.c $(USER_PATH)/pimoroni.c
endif
